...
//   // Menambahkan tulisan "FARID FILANTROPIA" yang bergerak
//   const text = "FARID FILANTROPIA";
...
//   // Menggerakkan tulisan "FARID"
//   const faridText = "FARID FILANTROPIA";
//   const faridTextWidth = context.measureText(faridText).width;
//   const faridTextX = (canvas.width - faridTextWidth) / 2;
//   const faridTextY = textY - 20;

//   for (let i = 0; i < faridText.length; i++) {
//     const char = faridText.charAt(i);
